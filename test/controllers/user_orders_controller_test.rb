...
class UserOrdersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_order" do
    assert_difference('UserOrder.count') do
      post user_orders_url, params: { user_order: { amount: @user_order.amount, order_id: @user_order.order_id, payment_mode: @user_order.payment_mode, product_id: @user_order.product_id, status: @user_order.status, user_id: @user_order.user_id } }
    end
  ...
  test "should update user_order" do
    patch user_order_url(@user_order), params: { user_order: { amount: @user_order.amount, order_id: @user_order.order_id, payment_mode: @user_order.payment_mode, product_id: @user_order.product_id, status: @user_order.status, user_id: @user_order.user_id } }
