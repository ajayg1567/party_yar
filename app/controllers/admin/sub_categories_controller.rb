class Admin::SubCategoriesController < ApplicationController
  ...
  def index
    ...
    @super_categories = SuperCategory.all.index_by(&:id)
  ...
  def create
    ...
    respond_to do |format|
      if @sub_category.save
        format.html { redirect_to admin_sub_category_url(@sub_category), notice: 'Sub category was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @sub_category.update(sub_category_params)
        format.html { redirect_to admin_sub_category_url(@sub_category), notice: 'Sub category was successfully updated.' }
  ...
  private
    ...
    def sub_category_params
      params.require(:sub_category).permit(:name, :category_id, :slug, :description, :banner)
    end
end
